...
import { GraphRepositoryNews } from "./graph.repo.news";

export abstract class CrudRepositoryNews<T extends BaseModel> extends GraphRepositoryNews {
